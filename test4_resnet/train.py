...
def main():
    ...
    model_weight_path = "./resnet34_pretrained.pth"
    ...
    optimizer = optim.Adam(params, lr=0.0001)  # [epoch 3] train_loss: 0.291  val_accuracy: 0.931

    epochs = 3
    best_acc = 0.0
    save_path = './resnet34_flower_photos.pth'
